...
import { getTopGainersLosersTemplate } from '../templates/gainersLosers.ts';
...
export default {
  ...
  handler: async (
    ...
    try {
      ...
      const context = composeContext({ state, template: getTopGainersLosersTemplate });
      ...
      const result = await generateObject({
        ...
        schema: GetTopGainersLosersSchema as any
      });
      ...
      const response = await axios.get<TopGainersLosersResponse>(`${baseUrl}/coins/top_gainers_losers`, {
