...
import { getTrendingPoolsTemplate } from '../templates/trendingPools.ts';
...
export const GetTrendingPoolsSchema = z.object({ limit: z.number().min(1).max(100).default(10) }).strict();

export type GetTrendingPoolsContent = z.infer<typeof GetTrendingPoolsSchema> & Content;

export const isGetTrendingPoolsContent = (obj: any): obj is GetTrendingPoolsContent => {
...
export default {
  ...
  handler: async (
    ...
    try {
      ...
      const trendingContext = composeContext({ state, template: getTrendingPoolsTemplate });

      const result = await generateObject({
        runtime,
        context: trendingContext,
        modelClass: ModelClass.LARGE,
        schema: GetTrendingPoolsSchema as any
      });
      ...
      if (callback) {
        callback({
          text: responseText,
          content: { trendingPools: formattedData, timestamp: new Date().toISOString() }
        });
      }
  ...
  examples: [[{ user: '{{user1}}', content: { text: 'Show me trending liquidity pools' } }, {
    ...
    content: {
      text:
        'Here are the top 5 hottest DEX pools:\n1. TRUMP / USDC\n   Market Cap: $8,844,297,825\n   FDV: $43,874,068,484\n   Reserve: $718,413,745\n   Created: 1/17/2025\n2. MELANIA / USDC\n   Market Cap: $954,636,707\n   FDV: $6,402,478,508\n   Reserve: $363,641,037\n   Created: 1/19/2025'
    }
    ...
    content: {
      text:
        'Here are all trending trading pools:\n1. MELANIA / USDC\n   Market Cap: $954,636,707\n   FDV: $6,402,478,508\n   Reserve: $363,641,037\n   Created: 1/19/2025\n2. TRUMP / USDC\n   Market Cap: $8,844,297,825\n   FDV: $43,874,068,484\n   Reserve: $718,413,745\n   Created: 1/17/2025'
    }
  }]] as ActionExample[][]
} as Action;
